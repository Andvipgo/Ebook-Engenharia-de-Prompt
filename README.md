...
- **Título:** criado com auxílio do ChatGPT  
- **Imagens:** geradas com MidJourney, Microsoft Copilot e Gemini (Nano Banana)  
- **Textos:** elaborados utilizando ChatGPT, Gemini e Microsoft Copilot  
- **Edição, diagramação e revisão final:** PowerPoint e Word  
- **Documentação e organização:** Microsoft OneNote  

---

## 📚 Instruções de Uso

### **1. Estruturação do título e conteúdo usando IA**
Use prompts no ChatGPT, Microsoft Copilot ou Gemini para criar:
- Títulos  
